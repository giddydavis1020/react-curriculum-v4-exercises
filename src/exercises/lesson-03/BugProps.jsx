...
// Explanation:
// The message was stored as a regular variable, causing React to not track the
// changes and update the UI. Using useState allow React to track the message value and
